   ...
   <div class="topbar-wrap white">
    ...
    <div class="main-wrap">
       <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.html">学生管理</a><span class="crumb-step">&gt;</span><span>修改学生</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="name" size="20" value="${stu.name }" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td><input class="common-text" name="pwd" size="20" value="${stu.pwd }" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>绩点成绩：</th>
                                <td><input class="common-text" name="gpascores" size="10" value="${stu.gpascores }" type="text"></td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                                ...
                                <td><input class="common-text" name="age" size="10" value="${stu.age }" type="text"></td>
                            </tr>
                         <tr>
                            ...
                            <tr>
                                <th></th>
                                <td>
                                    <input class="btn btn-primary btn6 mr10" onclick="history.go(-1)" value="提交" type="submit">
